...
x0k:
  ...
  concerns: [ontology, vocabulary, turtle, loading, publishing]
  tangle:
    crate: x0k-ontology
    root: src/load.rs
  edges:
...
<a name="chunk-module-doc"></a><sub>[`src/load.rs`](../../../x0k-ontology/src/load.rs) · `#module-doc`</sub>
...
<a name="chunk-imports"></a><sub>[`src/load.rs`](../../../x0k-ontology/src/load.rs) · `#imports`</sub>
...
<a name="chunk-xsd-string"></a><sub>[`src/load.rs`](../../../x0k-ontology/src/load.rs) · `#xsd-string`</sub>
...
<a name="chunk-load-error"></a><sub>[`src/load.rs`](../../../x0k-ontology/src/load.rs) · `#load-error`</sub>
...
<a name="chunk-load"></a><sub>[`src/load.rs`](../../../x0k-ontology/src/load.rs) · `#load`</sub>
...
directory one level up. The in-crate copy wins when it exists, which is the
only rule that makes both builds work without a feature flag.
...
<a name="chunk-shipped-modules-dir"></a><sub>[`src/load.rs`](../../../x0k-ontology/src/load.rs) · `#shipped-modules-dir`</sub>
...
<a name="chunk-module-file-paths"></a><sub>[`src/load.rs`](../../../x0k-ontology/src/load.rs) · `#module-file-paths`</sub>
...
<a name="chunk-check-files"></a><sub>[`src/load.rs`](../../../x0k-ontology/src/load.rs) · `#check-files`</sub>
...
<a name="chunk-raw-terms"></a><sub>[`src/load.rs`](../../../x0k-ontology/src/load.rs) · `#raw-terms`</sub>
...
<a name="chunk-parse-model"></a><sub>[`src/load.rs`](../../../x0k-ontology/src/load.rs) · `#parse-model`</sub>
...
<a name="chunk-parse-module-file"></a><sub>[`src/load.rs`](../../../x0k-ontology/src/load.rs) · `#parse-module-file`</sub>
...
<a name="chunk-assign-structural-uris"></a><sub>[`src/load.rs`](../../../x0k-ontology/src/load.rs) · `#assign-structural-uris`</sub>
...
<a name="chunk-assign-blank-component"></a><sub>[`src/load.rs`](../../../x0k-ontology/src/load.rs) · `#assign-blank-component`</sub>
...
<a name="chunk-node-entity"></a><sub>[`src/load.rs`](../../../x0k-ontology/src/load.rs) · `#node-entity`</sub>
...
<a name="chunk-tests"></a><sub>[`src/load.rs`](../../../x0k-ontology/src/load.rs) · `#tests`</sub>
...
<a name="chunk-root"></a><sub>[`src/load.rs`](../../../x0k-ontology/src/load.rs) · `#root` · assembles [module-doc](#chunk-module-doc) · [imports](#chunk-imports) · [xsd-string](#chunk-xsd-string) · [load-error](#chunk-load-error) · [load](#chunk-load) · [shipped-modules-dir](#chunk-shipped-modules-dir) · [module-file-paths](#chunk-module-file-paths) · [check-files](#chunk-check-files) · [raw-terms](#chunk-raw-terms) · [parse-model](#chunk-parse-model) · [parse-module-file](#chunk-parse-module-file) · [assign-structural-uris](#chunk-assign-structural-uris) · [assign-blank-component](#chunk-assign-blank-component) · [node-entity](#chunk-node-entity) · [tests](#chunk-tests)</sub>
