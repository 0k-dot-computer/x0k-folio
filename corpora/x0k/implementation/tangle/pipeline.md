...
[literate](../../wiki/literate-programming.md "x0k:wiki/literate-programming") chunk-to-source step — and its
plugins —
...
<a name="chunk-module-header"></a><sub>[`src/pipeline.rs`](../../../../x0k-tangle/src/pipeline.rs) · `#module-header`</sub>
...
<a name="chunk-imports"></a><sub>[`src/pipeline.rs`](../../../../x0k-tangle/src/pipeline.rs) · `#imports`</sub>
...
<a name="chunk-trait-def"></a><sub>[`src/pipeline.rs`](../../../../x0k-tangle/src/pipeline.rs) · `#trait-def`</sub>
...
<a name="chunk-pipeline-context"></a><sub>[`src/pipeline.rs`](../../../../x0k-tangle/src/pipeline.rs) · `#pipeline-context`</sub>
...
<a name="chunk-chunk-input"></a><sub>[`src/pipeline.rs`](../../../../x0k-tangle/src/pipeline.rs) · `#chunk-input`</sub>
...
<a name="chunk-comment-style"></a><sub>[`src/pipeline.rs`](../../../../x0k-tangle/src/pipeline.rs) · `#comment-style`</sub>
...
<a name="chunk-pipeline-output"></a><sub>[`src/pipeline.rs`](../../../../x0k-tangle/src/pipeline.rs) · `#pipeline-output`</sub>
...
<a name="chunk-error-types"></a><sub>[`src/pipeline.rs`](../../../../x0k-tangle/src/pipeline.rs) · `#error-types`</sub>
...
<a name="chunk-registry"></a><sub>[`src/pipeline.rs`](../../../../x0k-tangle/src/pipeline.rs) · `#registry`</sub>
...
<a name="chunk-tests"></a><sub>[`src/pipeline.rs`](../../../../x0k-tangle/src/pipeline.rs) · `#tests`</sub>
...
<a name="chunk-root"></a><sub>[`src/pipeline.rs`](../../../../x0k-tangle/src/pipeline.rs) · `#root` · assembles [module-header](#chunk-module-header) · [imports](#chunk-imports) · [trait-def](#chunk-trait-def) · [pipeline-context](#chunk-pipeline-context) · [chunk-input](#chunk-chunk-input) · [comment-style](#chunk-comment-style) · [pipeline-output](#chunk-pipeline-output) · [error-types](#chunk-error-types) · [registry](#chunk-registry) · [tests](#chunk-tests)</sub>
