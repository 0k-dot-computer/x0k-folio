...
<a name="chunk-corpus-layout"></a><sub>[`src/region_project.rs`](../../../../x0k-tangle/src/region_project.rs) · `#corpus-layout`</sub>
...
<a name="chunk-corpus-layout-current"></a><sub>[`src/region_project.rs`](../../../../x0k-tangle/src/region_project.rs) · `#corpus-layout-current`</sub>
...
<a name="chunk-corpus-layout-read"></a><sub>[`src/region_project.rs`](../../../../x0k-tangle/src/region_project.rs) · `#corpus-layout-read`</sub>
...
<a name="chunk-corpus-layout-accessors"></a><sub>[`src/region_project.rs`](../../../../x0k-tangle/src/region_project.rs) · `#corpus-layout-accessors`</sub>
