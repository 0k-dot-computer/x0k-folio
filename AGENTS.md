...
Setting up and integrating this into your own project: `guides/INTEGRATING.md`.
...
`crates/x0k-ontology/ontology/modules/{core,document,software}.ttl` are N-Triples;
