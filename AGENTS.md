...
Files marked `@generated` are derived from Markdown documents under
`corpora/x0k/implementation/`; edit those documents. Files without that
...
With the supplied software vocabulary, a capability uses three declarations
that `check` connects:
...
2. **The signifier**, where the face lives — not beside the claim: a fenced
   ...
   section of `corpora/x0k/implementation/tangle/crate.md` is the pattern. An
