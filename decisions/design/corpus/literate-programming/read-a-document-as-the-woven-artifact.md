...
*realized in* [x0k-tangle: the crate and its CLI](../../../../implementation/tangle/crate.md) · [Weaving literate documents into HTML](../../../../implementation/tangle/weave.md) · [Weaving a chapter for a forge](../../../../implementation/tangle/region-gfm.md)

*proven by* each test below, as its chapter tangles it and as it ran at projection.

<details><summary><code>the_weave_inverts_line_for_line</code> · <picture><source media="(prefers-color-scheme: dark)" srcset="../../../../assets/icons/passed-dark.svg"><img alt="passed" src="../../../../assets/icons/passed-light.svg" height="16"></picture> passed · <a href="../../../../implementation/tangle/region-gfm.md#chunk-tests">#tests</a> in Weaving a chapter for a forge</summary>
...
<details><summary><code>the_woven_chapter_tangles_to_the_same_chunks</code> · <picture><source media="(prefers-color-scheme: dark)" srcset="../../../../assets/icons/passed-dark.svg"><img alt="passed" src="../../../../assets/icons/passed-light.svg" height="16"></picture> passed · <a href="../../../../implementation/tangle/region-gfm.md#chunk-tests">#tests</a> in Weaving a chapter for a forge</summary>
...
<details><summary><code>a_string_literal_naming_an_id_is_not_a_woven_line</code> · <picture><source media="(prefers-color-scheme: dark)" srcset="../../../../assets/icons/passed-dark.svg"><img alt="passed" src="../../../../assets/icons/passed-light.svg" height="16"></picture> passed · <a href="../../../../implementation/tangle/region-gfm.md#chunk-tests">#tests</a> in Weaving a chapter for a forge</summary>
...
<details><summary><code>proof_excerpts_do_not_close_on_fences_inside_test_source</code> · <picture><source media="(prefers-color-scheme: dark)" srcset="../../../../assets/icons/passed-dark.svg"><img alt="passed" src="../../../../assets/icons/passed-light.svg" height="16"></picture> passed · <a href="../../../../implementation/tangle/region-gfm.md#chunk-tests">#tests</a> in Weaving a chapter for a forge</summary>

```rust
#[test]
fn proof_excerpts_do_not_close_on_fences_inside_test_source() {
    let tick = char::from(96).to_string().repeat(3);
    let source = format!("fn test() {{\nlet value = r#\"{tick}text\nexample\n{tick}\n\"#;\n}}\n");
    let proof = |name: &str| ProofEvidence {
        test: name.to_string(), outcome: Some("passed".to_string()),
        mark: "<img src=\"affordances/passed.svg\">".to_string(),
        chapter: ("Chapter".to_string(), "chapter.md".to_string()),
        chunk: "test".to_string(), source: source.clone(),
    };
    let evidence = AffordanceEvidence {
        id: "example".to_string(), marks: String::new(), status: "proven".to_string(),
        actors: String::new(), cues: vec![], chapters: vec![],
        proofs: vec![proof("one"), proof("two")],
    };
    let text = render_evidence(&evidence);
    let mut html = String::new();
    let mut code_blocks = 0;
    for event in pulldown_cmark::Parser::new(&text) {
        match event {
            pulldown_cmark::Event::Html(value) | pulldown_cmark::Event::InlineHtml(value) => html.push_str(&value),
            pulldown_cmark::Event::Start(pulldown_cmark::Tag::CodeBlock(_)) => code_blocks += 1,
            _ => {},
        }
    }
    assert_eq!(html.matches("<img src=\"affordances/passed.svg\">").count(), 2, "{html}");
    assert!(text.contains(&format!("{tick}{tick_char}rust", tick_char=char::from(96))));
    assert_eq!(code_blocks, 2, "{text}");
}
```
...
<details><summary><code>relative_links_climb_out_and_descend</code> · <picture><source media="(prefers-color-scheme: dark)" srcset="../../../../assets/icons/passed-dark.svg"><img alt="passed" src="../../../../assets/icons/passed-light.svg" height="16"></picture> passed · <a href="../../../../implementation/tangle/region-gfm.md#chunk-tests">#tests</a> in Weaving a chapter for a forge</summary>
...
<details><summary><code>single_language_chunk_renders_without_tabs</code> · <picture><source media="(prefers-color-scheme: dark)" srcset="../../../../assets/icons/passed-dark.svg"><img alt="passed" src="../../../../assets/icons/passed-light.svg" height="16"></picture> passed · <a href="../../../../implementation/tangle/weave.md#chunk-tests">#tests</a> in Weaving literate documents into HTML</summary>
...
<details><summary><code>multi_language_chunk_renders_tabs</code> · <picture><source media="(prefers-color-scheme: dark)" srcset="../../../../assets/icons/passed-dark.svg"><img alt="passed" src="../../../../assets/icons/passed-light.svg" height="16"></picture> passed · <a href="../../../../implementation/tangle/weave.md#chunk-tests">#tests</a> in Weaving literate documents into HTML</summary>
...
<details><summary><code>mixed_single_and_multi_lang_chunks</code> · <picture><source media="(prefers-color-scheme: dark)" srcset="../../../../assets/icons/passed-dark.svg"><img alt="passed" src="../../../../assets/icons/passed-light.svg" height="16"></picture> passed · <a href="../../../../implementation/tangle/weave.md#chunk-tests">#tests</a> in Weaving literate documents into HTML</summary>
...
<details><summary><code>params_block_renders_data_div</code> · <picture><source media="(prefers-color-scheme: dark)" srcset="../../../../assets/icons/passed-dark.svg"><img alt="passed" src="../../../../assets/icons/passed-light.svg" height="16"></picture> passed · <a href="../../../../implementation/tangle/weave.md#chunk-tests">#tests</a> in Weaving literate documents into HTML</summary>
...
<details><summary><code>tab_buttons_have_onclick</code> · <picture><source media="(prefers-color-scheme: dark)" srcset="../../../../assets/icons/passed-dark.svg"><img alt="passed" src="../../../../assets/icons/passed-light.svg" height="16"></picture> passed · <a href="../../../../implementation/tangle/weave.md#chunk-tests">#tests</a> in Weaving literate documents into HTML</summary>
...
<details><summary><code>rust_chunk_emits_highlight_spans</code> · <picture><source media="(prefers-color-scheme: dark)" srcset="../../../../assets/icons/passed-dark.svg"><img alt="passed" src="../../../../assets/icons/passed-light.svg" height="16"></picture> passed · <a href="../../../../implementation/tangle/weave.md#chunk-tests">#tests</a> in Weaving literate documents into HTML</summary>
...
<details><summary><code>classify_comment_kinds</code> · <picture><source media="(prefers-color-scheme: dark)" srcset="../../../../assets/icons/passed-dark.svg"><img alt="passed" src="../../../../assets/icons/passed-light.svg" height="16"></picture> passed · <a href="../../../../implementation/tangle/weave.md#chunk-tests">#tests</a> in Weaving literate documents into HTML</summary>
...
<details><summary><code>comment_run_grouping_wraps_and_classifies</code> · <picture><source media="(prefers-color-scheme: dark)" srcset="../../../../assets/icons/passed-dark.svg"><img alt="passed" src="../../../../assets/icons/passed-light.svg" height="16"></picture> passed · <a href="../../../../implementation/tangle/weave.md#chunk-tests">#tests</a> in Weaving literate documents into HTML</summary>
...
<details><summary><code>render_doc_markdown_strips_markers_and_renders</code> · <picture><source media="(prefers-color-scheme: dark)" srcset="../../../../assets/icons/passed-dark.svg"><img alt="passed" src="../../../../assets/icons/passed-light.svg" height="16"></picture> passed · <a href="../../../../implementation/tangle/weave.md#chunk-tests">#tests</a> in Weaving literate documents into HTML</summary>
...
<details><summary><code>math_renders_to_mathml</code> · <picture><source media="(prefers-color-scheme: dark)" srcset="../../../../assets/icons/passed-dark.svg"><img alt="passed" src="../../../../assets/icons/passed-light.svg" height="16"></picture> passed · <a href="../../../../implementation/tangle/weave.md#chunk-tests">#tests</a> in Weaving literate documents into HTML</summary>
...
<details><summary><code>bad_math_falls_back_to_raw_tex</code> · <picture><source media="(prefers-color-scheme: dark)" srcset="../../../../assets/icons/passed-dark.svg"><img alt="passed" src="../../../../assets/icons/passed-light.svg" height="16"></picture> passed · <a href="../../../../implementation/tangle/weave.md#chunk-tests">#tests</a> in Weaving literate documents into HTML</summary>
...
<details><summary><code>doc_comment_lifts_to_symbol_and_card</code> · <picture><source media="(prefers-color-scheme: dark)" srcset="../../../../assets/icons/passed-dark.svg"><img alt="passed" src="../../../../assets/icons/passed-light.svg" height="16"></picture> passed · <a href="../../../../implementation/tangle/weave.md#chunk-tests">#tests</a> in Weaving literate documents into HTML</summary>
...
<details><summary><code>doc_comment_skips_attribute_to_reach_symbol</code> · <picture><source media="(prefers-color-scheme: dark)" srcset="../../../../assets/icons/passed-dark.svg"><img alt="passed" src="../../../../assets/icons/passed-light.svg" height="16"></picture> passed · <a href="../../../../implementation/tangle/weave.md#chunk-tests">#tests</a> in Weaving literate documents into HTML</summary>
...
<details><summary><code>inner_doc_anchors_to_chunk_header</code> · <picture><source media="(prefers-color-scheme: dark)" srcset="../../../../assets/icons/passed-dark.svg"><img alt="passed" src="../../../../assets/icons/passed-light.svg" height="16"></picture> passed · <a href="../../../../implementation/tangle/weave.md#chunk-tests">#tests</a> in Weaving literate documents into HTML</summary>
...
<details><summary><code>doc_comment_without_symbol_falls_back_inline</code> · <picture><source media="(prefers-color-scheme: dark)" srcset="../../../../assets/icons/passed-dark.svg"><img alt="passed" src="../../../../assets/icons/passed-light.svg" height="16"></picture> passed · <a href="../../../../implementation/tangle/weave.md#chunk-tests">#tests</a> in Weaving literate documents into HTML</summary>
...
<details><summary><code>comment_run_preserves_indentation_bytes</code> · <picture><source media="(prefers-color-scheme: dark)" srcset="../../../../assets/icons/passed-dark.svg"><img alt="passed" src="../../../../assets/icons/passed-light.svg" height="16"></picture> passed · <a href="../../../../implementation/tangle/weave.md#chunk-tests">#tests</a> in Weaving literate documents into HTML</summary>
...
<details><summary><code>ref_line_is_not_highlighted</code> · <picture><source media="(prefers-color-scheme: dark)" srcset="../../../../assets/icons/passed-dark.svg"><img alt="passed" src="../../../../assets/icons/passed-light.svg" height="16"></picture> passed · <a href="../../../../implementation/tangle/weave.md#chunk-tests">#tests</a> in Weaving literate documents into HTML</summary>
...
<details><summary><code>escaped_ref_line_renders_as_the_literal_without_an_anchor</code> · <picture><source media="(prefers-color-scheme: dark)" srcset="../../../../assets/icons/passed-dark.svg"><img alt="passed" src="../../../../assets/icons/passed-light.svg" height="16"></picture> passed · <a href="../../../../implementation/tangle/weave.md#chunk-tests">#tests</a> in Weaving literate documents into HTML</summary>
...
<details><summary><code>headings_get_slug_ids</code> · <picture><source media="(prefers-color-scheme: dark)" srcset="../../../../assets/icons/passed-dark.svg"><img alt="passed" src="../../../../assets/icons/passed-light.svg" height="16"></picture> passed · <a href="../../../../implementation/tangle/weave.md#chunk-tests">#tests</a> in Weaving literate documents into HTML</summary>
...
<details><summary><code>duplicate_headings_get_deduped_ids</code> · <picture><source media="(prefers-color-scheme: dark)" srcset="../../../../assets/icons/passed-dark.svg"><img alt="passed" src="../../../../assets/icons/passed-light.svg" height="16"></picture> passed · <a href="../../../../implementation/tangle/weave.md#chunk-tests">#tests</a> in Weaving literate documents into HTML</summary>
...
<details><summary><code>heading_with_inline_markup_slugs_and_preserves_markup</code> · <picture><source media="(prefers-color-scheme: dark)" srcset="../../../../assets/icons/passed-dark.svg"><img alt="passed" src="../../../../assets/icons/passed-light.svg" height="16"></picture> passed · <a href="../../../../implementation/tangle/weave.md#chunk-tests">#tests</a> in Weaving literate documents into HTML</summary>
