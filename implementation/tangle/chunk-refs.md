...
substrate](../../background/literate-programming.md "x0k:wiki/literate-programming") explaining itself. Some of `x0k-tangle`'s own modules contain
...
<a name="chunk-imports"></a><sub>[`src/chunk_refs.rs`](../../crates/x0k-tangle/src/chunk_refs.rs) · `#imports`</sub>
...
<a name="chunk-find-chunk-refs-aware-fn"></a><sub>[`src/chunk_refs.rs`](../../crates/x0k-tangle/src/chunk_refs.rs) · `#find-chunk-refs-aware-fn`</sub>
...
<a name="chunk-line-start-offsets-fn"></a><sub>[`src/chunk_refs.rs`](../../crates/x0k-tangle/src/chunk_refs.rs) · `#line-start-offsets-fn`</sub>
...
<a name="chunk-walk-collect-fn"></a><sub>[`src/chunk_refs.rs`](../../crates/x0k-tangle/src/chunk_refs.rs) · `#walk-collect-fn`</sub>
