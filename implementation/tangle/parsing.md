...
<a name="chunk-split-frontmatter-fn"></a><sub>[`src/parser.rs`](../../crates/x0k-tangle/src/parser.rs) · `#split-frontmatter-fn`</sub>
...
<a name="chunk-parse-tangle-frontmatter-fn"></a><sub>[`src/parser.rs`](../../crates/x0k-tangle/src/parser.rs) · `#parse-tangle-frontmatter-fn`</sub>
