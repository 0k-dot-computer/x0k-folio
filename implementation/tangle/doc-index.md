...
<a name="chunk-extract-title"></a><sub>[`src/index.rs`](../../crates/x0k-tangle/src/index.rs) · `#extract-title`</sub>
...
<a name="chunk-extract-frontmatter-fields"></a><sub>[`src/index.rs`](../../crates/x0k-tangle/src/index.rs) · `#extract-frontmatter-fields`</sub>
