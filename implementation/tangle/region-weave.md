...
<a name="chunk-module-doc"></a><sub>[`src/region_weave.rs`](../../crates/x0k-tangle/src/region_weave.rs) · `#module-doc`</sub>
...
<a name="chunk-uses"></a><sub>[`src/region_weave.rs`](../../crates/x0k-tangle/src/region_weave.rs) · `#uses`</sub>
...
<a name="chunk-region-member"></a><sub>[`src/region_weave.rs`](../../crates/x0k-tangle/src/region_weave.rs) · `#region-member`</sub>
...
<a name="chunk-artifact-file"></a><sub>[`src/region_weave.rs`](../../crates/x0k-tangle/src/region_weave.rs) · `#artifact-file`</sub>
...
<a name="chunk-region-weave-output"></a><sub>[`src/region_weave.rs`](../../crates/x0k-tangle/src/region_weave.rs) · `#region-weave-output`</sub>
...
/// woven via [`crate::weave::weave_html`], its cross-doc links rewritten to artifact-relative
/// paths, and a site nav + scoped `<style>` spliced in.
pub fn weave_region(input: &RegionInput) -> Result<RegionWeaveOutput> {
    weave_region_with_vocabulary(input, &x0k_ontology::concept_facts::OntologyModel::shipped())
}

pub fn weave_region_with_vocabulary(
    input: &RegionInput, base: &x0k_ontology::concept_facts::OntologyModel,
) -> Result<RegionWeaveOutput> {
    let documents: Vec<_> = input.members.iter().map(|m| (m.uri.as_str(), m.content.as_str())).collect();
    let instances = crate::instance_rendering::InstancePresentation::collect(&documents, base);
...
<a name="chunk-weave-path-maps"></a><sub>[`src/region_weave.rs`](../../crates/x0k-tangle/src/region_weave.rs) · `#weave-path-maps`</sub>
...
<a name="chunk-weave-collections"></a><sub>[`src/region_weave.rs`](../../crates/x0k-tangle/src/region_weave.rs) · `#weave-collections`</sub>
...
for m in &input.members {
    ...
    let out =
        crate::weave::weave_html_with_instances(&content, &parsed, &m.uri, &instances).with_context(|| format!("weaving member `{}`", m.uri))?;
...
<a name="chunk-weave-second-pass"></a><sub>[`src/region_weave.rs`](../../crates/x0k-tangle/src/region_weave.rs) · `#weave-second-pass`</sub>
...
<a name="chunk-weave-atlas"></a><sub>[`src/region_weave.rs`](../../crates/x0k-tangle/src/region_weave.rs) · `#weave-atlas`</sub>
...
<a name="chunk-weave-output"></a><sub>[`src/region_weave.rs`](../../crates/x0k-tangle/src/region_weave.rs) · `#weave-output`</sub>
...
<a name="chunk-region-doc-source"></a><sub>[`src/region_weave.rs`](../../crates/x0k-tangle/src/region_weave.rs) · `#region-doc-source`</sub>
...
<a name="chunk-scan-media-refs"></a><sub>[`src/region_weave.rs`](../../crates/x0k-tangle/src/region_weave.rs) · `#scan-media-refs`</sub>
...
<a name="chunk-entry-file"></a><sub>[`src/region_weave.rs`](../../crates/x0k-tangle/src/region_weave.rs) · `#entry-file`</sub>
...
<a name="chunk-wiki-title-map"></a><sub>[`src/region_weave.rs`](../../crates/x0k-tangle/src/region_weave.rs) · `#wiki-title-map`</sub>
...
<a name="chunk-rewrite-wikilinks"></a><sub>[`src/region_weave.rs`](../../crates/x0k-tangle/src/region_weave.rs) · `#rewrite-wikilinks`</sub>
...
<a name="chunk-uri-to-path"></a><sub>[`src/region_weave.rs`](../../crates/x0k-tangle/src/region_weave.rs) · `#uri-to-path`</sub>
...
<a name="chunk-nav-entry"></a><sub>[`src/region_weave.rs`](../../crates/x0k-tangle/src/region_weave.rs) · `#nav-entry`</sub>
...
<a name="chunk-rewrite-cross-doc-links"></a><sub>[`src/region_weave.rs`](../../crates/x0k-tangle/src/region_weave.rs) · `#rewrite-cross-doc-links`</sub>
...
<a name="chunk-site-nav"></a><sub>[`src/region_weave.rs`](../../crates/x0k-tangle/src/region_weave.rs) · `#site-nav`</sub>
...
<a name="chunk-validate"></a><sub>[`src/region_weave.rs`](../../crates/x0k-tangle/src/region_weave.rs) · `#validate`</sub>
...
<a name="chunk-tests"></a><sub>[`src/region_weave.rs`](../../crates/x0k-tangle/src/region_weave.rs) · `#tests`</sub>
...
<a name="chunk-region-tests-doc"></a><sub>[`tests/region_weave.rs`](../../crates/x0k-tangle/tests/region_weave.rs) · `#region-tests-doc`</sub>
...
<a name="chunk-region-tests-uses"></a><sub>[`tests/region_weave.rs`](../../crates/x0k-tangle/tests/region_weave.rs) · `#region-tests-uses`</sub>
...
<a name="chunk-region-tests-atlas"></a><sub>[`tests/region_weave.rs`](../../crates/x0k-tangle/tests/region_weave.rs) · `#region-tests-atlas`</sub>
...
<a name="chunk-region-tests-self-contained"></a><sub>[`tests/region_weave.rs`](../../crates/x0k-tangle/tests/region_weave.rs) · `#region-tests-self-contained`</sub>
...
<a name="chunk-region-tests-dangling-link"></a><sub>[`tests/region_weave.rs`](../../crates/x0k-tangle/tests/region_weave.rs) · `#region-tests-dangling-link`</sub>
...
<a name="chunk-region-tests-missing-entry"></a><sub>[`tests/region_weave.rs`](../../crates/x0k-tangle/tests/region_weave.rs) · `#region-tests-missing-entry`</sub>
...
<a name="chunk-region-tests-project-to-disk"></a><sub>[`tests/region_weave.rs`](../../crates/x0k-tangle/tests/region_weave.rs) · `#region-tests-project-to-disk`</sub>
...
<a name="chunk-region-tests-default-entry"></a><sub>[`tests/region_weave.rs`](../../crates/x0k-tangle/tests/region_weave.rs) · `#region-tests-default-entry`</sub>
...
<a name="chunk-region-tests-self-booting"></a><sub>[`tests/region_weave.rs`](../../crates/x0k-tangle/tests/region_weave.rs) · `#region-tests-self-booting`</sub>
...
<a name="chunk-region-tests-transclude-two-briefs"></a><sub>[`tests/region_weave.rs`](../../crates/x0k-tangle/tests/region_weave.rs) · `#region-tests-transclude-two-briefs`</sub>
...
(`corpora/x0k/decisions/design/corpus/transclusion.md` §"Edit-through") proved at the
weave/resolution seam, which is the naga-free analogue of the native
re-render.

<a name="chunk-region-tests-edit-through"></a><sub>[`tests/region_weave.rs`](../../crates/x0k-tangle/tests/region_weave.rs) · `#region-tests-edit-through`</sub>
...
<a name="chunk-region-tests-self-transclusion"></a><sub>[`tests/region_weave.rs`](../../crates/x0k-tangle/tests/region_weave.rs) · `#region-tests-self-transclusion`</sub>
