...
<a name="chunk-root"></a><sub>[`src/pipeline.rs`](../../crates/x0k-tangle/src/pipeline.rs) · `#root` · assembles [module-header](#chunk-module-header) · [imports](#chunk-imports) · [trait-def](#chunk-trait-def) · [pipeline-context](#chunk-pipeline-context) · [chunk-input](#chunk-chunk-input) · [comment-style](#chunk-comment-style) · [pipeline-output](#chunk-pipeline-output) · [error-types](#chunk-error-types) · [registry](#chunk-registry) · [tests](#chunk-tests)</sub>
