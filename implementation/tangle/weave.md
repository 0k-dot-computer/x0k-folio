...
<a name="chunk-imports"></a><sub>[`src/weave.rs`](../../crates/x0k-tangle/src/weave.rs) · `#imports`</sub>
...
should not disagree about what a document is called, which is the argument
...
pub fn weave_html(content: &str, doc: &ParsedDocument) -> Result<WeaveOutput> {
    let source = doc.id.as_deref().unwrap_or("document");
    let instances = crate::instance_rendering::InstancePresentation::same_document(source, content);
    weave_html_with_instances(content, doc, source, &instances)
}

pub fn weave_html_with_instances(
    ...
    html.push_str(crate::instance_rendering::STYLESHEET);
    html.push_str("</style>\n");
    html.push_str("</head>\n<body>\n");
...
<a name="chunk-render-code-block-fn"></a><sub>[`src/weave.rs`](../../crates/x0k-tangle/src/weave.rs) · `#render-code-block-fn`</sub>
...
fn render_code_block(
    ...
    if let Some(mut view) = instances.view(source, info, code) {
        *chunk_seq += 1;
        ...
        html.push_str(&crate::instance_rendering::html(&view, code));
        return Ok(());
    }
...
<a name="chunk-render-tabbed-chunk-fn"></a><sub>[`src/weave.rs`](../../crates/x0k-tangle/src/weave.rs) · `#render-tabbed-chunk-fn`</sub>
...
<a name="chunk-capitalize-lang-fn"></a><sub>[`src/weave.rs`](../../crates/x0k-tangle/src/weave.rs) · `#capitalize-lang-fn`</sub>
...
<a name="chunk-render-code-with-refs-fn"></a><sub>[`src/weave.rs`](../../crates/x0k-tangle/src/weave.rs) · `#render-code-with-refs-fn`</sub>
...
<a name="chunk-stylesheet"></a><sub>[`src/weave.rs`](../../crates/x0k-tangle/src/weave.rs) · `#stylesheet`</sub>
