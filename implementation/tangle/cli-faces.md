...
<a name="chunk-proving-chunks"></a><sub>[`src/faces.rs`](../../crates/x0k-tangle/src/faces.rs) · `#proving-chunks`</sub>
...
<a name="chunk-fact-value"></a><sub>[`src/faces.rs`](../../crates/x0k-tangle/src/faces.rs) · `#fact-value`</sub>
...
<a name="chunk-affordance-record"></a><sub>[`src/faces.rs`](../../crates/x0k-tangle/src/faces.rs) · `#affordance-record`</sub>
...
<a name="chunk-icon-report"></a><sub>[`src/faces.rs`](../../crates/x0k-tangle/src/faces.rs) · `#icon-report`</sub>
...
<a name="chunk-check-section"></a><sub>[`src/faces.rs`](../../crates/x0k-tangle/src/faces.rs) · `#check-section`</sub>
...
<a name="chunk-declared-icons"></a><sub>[`src/faces.rs`](../../crates/x0k-tangle/src/faces.rs) · `#declared-icons`</sub>
...
<a name="chunk-tests-uses"></a><sub>[`tests/cli_faces.rs`](../../crates/x0k-tangle/tests/cli_faces.rs) · `#tests-uses`</sub>
...
<a name="chunk-tests-check"></a><sub>[`tests/cli_faces.rs`](../../crates/x0k-tangle/tests/cli_faces.rs) · `#tests-check` · proves [Check a document against its vocabulary](../../decisions/design/corpus/publish-a-region-as-a-repository/check-a-document-against-its-vocabulary.md)</sub>
