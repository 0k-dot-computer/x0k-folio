...
<a name="chunk-vocabulary"></a><sub>[`src/concept_facts.rs`](../../crates/x0k-ontology/src/concept_facts.rs) · `#vocabulary`</sub>
...
pub const VANN_PREFERRED_NAMESPACE_PREFIX: &str = "http://purl.org/vocab/vann/preferredNamespacePrefix";
...
<a name="chunk-module-iri"></a><sub>[`src/concept_facts.rs`](../../crates/x0k-ontology/src/concept_facts.rs) · `#module-iri`</sub>
...
<a name="chunk-fact-value"></a><sub>[`src/concept_facts.rs`](../../crates/x0k-ontology/src/concept_facts.rs) · `#fact-value`</sub>
...
<a name="chunk-fact-constructors"></a><sub>[`src/concept_facts.rs`](../../crates/x0k-ontology/src/concept_facts.rs) · `#fact-constructors`</sub>
...
<a name="chunk-model"></a><sub>[`src/concept_facts.rs`](../../crates/x0k-ontology/src/concept_facts.rs) · `#model`</sub>
...
<a name="chunk-close-root"></a><sub>[`src/concept_facts.rs`](../../crates/x0k-ontology/src/concept_facts.rs) · `#close-root`</sub>
...
<a name="chunk-declared-entities"></a><sub>[`src/concept_facts.rs`](../../crates/x0k-ontology/src/concept_facts.rs) · `#declared-entities`</sub>
...
<a name="chunk-view-records"></a><sub>[`src/concept_facts.rs`](../../crates/x0k-ontology/src/concept_facts.rs) · `#view-records`</sub>
...
<a name="chunk-class-view"></a><sub>[`src/concept_facts.rs`](../../crates/x0k-ontology/src/concept_facts.rs) · `#class-view`</sub>

```rust {#class-view}
impl OntologyModel {
    /// The extension namespaces the modules declare, as `(prefix, namespace)`.
    pub fn extension_namespaces(&self) -> Vec<(String, String)> {
        let mut out = BTreeSet::new();
        for iri in self.entities_typed_as(OWL_ONTOLOGY) {
            let mut prefixes = self.text_values(&iri, VANN_PREFERRED_NAMESPACE_PREFIX);
            if prefixes.is_empty() {
                prefixes.extend(module_name(&iri).map(str::to_string));
            }
            for prefix in prefixes {
                for namespace in self.text_values(&iri, VANN_PREFERRED_NAMESPACE_URI) {
                    out.insert((prefix.clone(), namespace));
                }
            }
        }
...
<a name="chunk-class-values"></a><sub>[`src/concept_facts.rs`](../../crates/x0k-ontology/src/concept_facts.rs) · `#class-values`</sub>
...
<a name="chunk-rdf-list"></a><sub>[`src/concept_facts.rs`](../../crates/x0k-ontology/src/concept_facts.rs) · `#rdf-list`</sub>
...
<a name="chunk-decision-predicates"></a><sub>[`src/concept_facts.rs`](../../crates/x0k-ontology/src/concept_facts.rs) · `#decision-predicates`</sub>
...
<a name="chunk-module-records"></a><sub>[`src/concept_facts.rs`](../../crates/x0k-ontology/src/concept_facts.rs) · `#module-records`</sub>
...
impl OntologyModel {
    pub fn modules(&self) -> Vec<ModuleRecord> {
        self.entities_typed_as(OWL_ONTOLOGY).into_iter().filter_map(|iri| {
            let name = module_name(&iri).map(str::to_string).or_else(|| {
                let mut prefixes = self.text_values(&iri, VANN_PREFERRED_NAMESPACE_PREFIX);
                prefixes.sort();
...
<a name="chunk-import-order"></a><sub>[`src/concept_facts.rs`](../../crates/x0k-ontology/src/concept_facts.rs) · `#import-order`</sub>
...
<a name="chunk-module-views"></a><sub>[`src/concept_facts.rs`](../../crates/x0k-ontology/src/concept_facts.rs) · `#module-views`</sub>
...
<a name="chunk-module-facts"></a><sub>[`src/concept_facts.rs`](../../crates/x0k-ontology/src/concept_facts.rs) · `#module-facts`</sub>
...
<a name="chunk-vocabulary-names"></a><sub>[`src/concept_facts.rs`](../../crates/x0k-ontology/src/concept_facts.rs) · `#vocabulary-names`</sub>
...
impl OntologyModel {
    ...
    pub fn schemes(&self) -> BTreeSet<String> {
        ...
        out.extend(self.extension_namespaces().into_iter().map(|(prefix, _)| prefix));
        out
    }
}
```

<a name="chunk-naming"></a><sub>[`src/concept_facts.rs`](../../crates/x0k-ontology/src/concept_facts.rs) · `#naming`</sub>
...
<a name="chunk-shape-predicates"></a><sub>[`src/concept_facts.rs`](../../crates/x0k-ontology/src/concept_facts.rs) · `#shape-predicates`</sub>
...
<a name="chunk-render-view"></a><sub>[`src/concept_facts.rs`](../../crates/x0k-ontology/src/concept_facts.rs) · `#render-view`</sub>
...
<a name="chunk-render-atoms"></a><sub>[`src/concept_facts.rs`](../../crates/x0k-ontology/src/concept_facts.rs) · `#render-atoms`</sub>
...
<a name="chunk-concept-fact-contract-tests"></a><sub>[`src/concept_facts.rs`](../../crates/x0k-ontology/src/concept_facts.rs) · `#concept-fact-contract-tests`</sub>
...
## Names outside the host vocabulary

A document-carried module can have any ontology IRI. Its standard
`vann:preferredNamespacePrefix` and `vann:preferredNamespaceUri` facts
supply compact names. Several prefixes can denote one namespace; expansion
preserves that equivalence and compaction chooses the lexically first
prefix. The built-in x0k spelling remains fixed. Collection validation
refuses a prefix bound to different namespaces before these views run.
Modules in the host's established IRI layout retain their existing names.
