...
<a name="chunk-worker"></a><sub>[`src/lib.rs`](../../crates/x0k-folio-dialog/src/lib.rs) · `#worker`</sub>
...
<a name="chunk-manifest"></a><sub>[`Cargo.toml`](../../crates/x0k-folio-dialog/Cargo.toml) · `#manifest`</sub>
...
<a name="chunk-source-support"></a><sub>[`src/database.rs`](../../crates/x0k-folio-dialog/src/database.rs) · `#source-support`</sub>
...
<a name="chunk-native-query"></a><sub>[`src/query.rs`](../../crates/x0k-folio-dialog/src/query.rs) · `#native-query`</sub>
...
<a name="chunk-store-regressions"></a><sub>[`tests/store.rs`](../../crates/x0k-folio-dialog/tests/store.rs) · `#store-regressions`</sub>
...
<a name="chunk-publication-regressions"></a><sub>[`src/database.rs`](../../crates/x0k-folio-dialog/src/database.rs) · `#publication-regressions`</sub>
...
<a name="chunk-recursive-rule-regression"></a><sub>[`tests/store.rs`](../../crates/x0k-folio-dialog/tests/store.rs) · `#recursive-rule-regression`</sub>
...
<a name="chunk-query-syntax-boundary"></a><sub>[`src/query.rs`](../../crates/x0k-folio-dialog/src/query.rs) · `#query-syntax-boundary`</sub>
...
<a name="chunk-instance-boundary"></a><sub>[`tests/store.rs`](../../crates/x0k-folio-dialog/tests/store.rs) · `#instance-boundary`</sub>
