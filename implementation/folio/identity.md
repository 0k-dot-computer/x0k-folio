...
<a name="chunk-entity-id"></a><sub>[`src/entity_id.rs`](../../crates/x0k-folio/src/entity_id.rs) · `#entity-id`</sub>
...
<a name="chunk-from-str"></a><sub>[`src/entity_id.rs`](../../crates/x0k-folio/src/entity_id.rs) · `#from-str`</sub>
...
<a name="chunk-root"></a><sub>[`src/entity_id.rs`](../../crates/x0k-folio/src/entity_id.rs) · `#root` · assembles [module-doc](#chunk-module-doc) · [entity-id](#chunk-entity-id) · [display](#chunk-display) · [from-str](#chunk-from-str) · [error](#chunk-error) · [percent](#chunk-percent) · [tests](#chunk-tests)</sub>
