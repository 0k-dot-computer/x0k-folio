...
<a name="chunk-modules-and-exports"></a><sub>[`src/lib.rs`](../../crates/x0k-folio/src/lib.rs) · `#modules-and-exports`</sub>
...
<a name="chunk-root"></a><sub>[`src/lib.rs`](../../crates/x0k-folio/src/lib.rs) · `#root` · assembles [module-doc](#chunk-module-doc) · [modules-and-exports](#chunk-modules-and-exports) · [register-factory](#chunk-register-factory)</sub>
...
<a name="chunk-check-standalone"></a><sub>[`tools/check-standalone.sh`](../../crates/x0k-folio/tools/check-standalone.sh) · `#check-standalone`</sub>
